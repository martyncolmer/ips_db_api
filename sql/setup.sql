...
(SELECT name
 ...
 WHERE name = 'ips')
  BEGIN
    CREATE LOGIN [ips] WITH PASSWORD = N'yourStrong123Password', DEFAULT_DATABASE = ips
  END
GO
...
CREATE USER [ips] FOR LOGIN [ips]
GO

grant control to ips
GO
...
(
  ...
  constraint RUN_pk
    primary key nonclustered (RUN_ID)
)
go
...
(
  ...
  PORTROUTE      numeric(4),
  ARRIVEDEPART   numeric(1),
  TRAFFICTOTAL   numeric(12, 3) not null,
  PERIODSTART    nvarchar(10),
  PERIODEND      nvarchar(10),
  AM_PM_NIGHT    numeric(1),
  HAUL           nvarchar(2),
...
(
  ...
  REGION         numeric(3),
  ARRIVEDEPART   numeric(1),
  UNSAMP_TOTAL   numeric(12, 3) not null
)
go
